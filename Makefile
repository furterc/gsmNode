...
OBJECTS += ./Src/MQTTNetwork.o
OBJECTS += ./Src/SIM800L.o
OBJECTS += ./Src/main.o
OBJECTS += ./caboodle.git/src/console.o
OBJECTS += ./caboodle.git/src/crc.o
OBJECTS += ./caboodle.git/src/hdlc_framer.o
OBJECTS += ./caboodle.git/src/led.o
OBJECTS += ./caboodle.git/src/logger.o
...
OBJECTS += ./mbed-os/features/deprecated_warnings/FEATURE_NANOSTACK/feature_nanostack_is_deprecated.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1550692466.84
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1550692466.84
